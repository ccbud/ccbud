/* CCBuddy site i18n — same 5 languages as the app, auto-detected from the browser. No build step.
   Text nodes use [data-i18n]; rich text uses [data-i18n-html]. Choice persists in localStorage. */
(function () {
  var DICT = {
    en: {
      'meta.title': 'CCBuddy — Coding CLI Buddy',
      ...
      'flow.n1t': 'Claude Code', 'flow.n1s': 'your CLI', 'flow.n2t': 'CCBuddy', 'flow.n2s': 'local gateway', 'flow.n3t': 'Any provider', 'flow.n3s': 'Kimi · DeepSeek · GLM…',
      ...
      'why.p2': 'No accounts. No cloud. No telemetry. CCBuddy writes Claude Code’s settings for you when you connect, and puts them back exactly as they were when you disconnect. Your keys, history and usage never leave the machine.',
      ...
      'f1.desc': 'Pick a provider and press connect. CCBuddy points Claude Code at the local gateway; press again to go back to official. No terminal, no config spelunking.',
      ...
      'f2.desc': 'Keep all your providers in one place and switch with a click. Per provider, map model aliases — so Claude Code keeps asking for “opus” while CCBuddy quietly routes it to whatever you chose.',
      ...
      'how.s2t': 'Press connect', 'how.s2d': 'CCBuddy writes Claude Code’s settings to point at localhost. That’s it.',
      'how.s3t': 'Use Claude Code', 'how.s3d': 'Everything flows through CCBuddy — switch providers anytime, watch usage live.',
      ...
      'faq.q1': 'Is it free and open source?', 'faq.a1': 'Yes. CCBuddy is open source and free to use — you bring your own provider keys.',
      'faq.q2': 'Does my data go anywhere?', 'faq.a2': 'No. CCBuddy runs as a local gateway on your machine. Your keys, conversations and usage never leave it — there is no CCBuddy account or server.',
      ...
      'faq.q4': 'Will it mess up my Claude Code setup?', 'faq.a4': 'No. CCBuddy snapshots your existing Claude Code settings before connecting and restores that exact snapshot when you disconnect.',
    ...
    zh: {
      ...
      'flow.n1t': 'Claude Code', 'flow.n1s': '你的 CLI', 'flow.n2t': 'CCBuddy', 'flow.n2s': '本地网关', 'flow.n3t': '任意服务商', 'flow.n3s': 'Kimi · DeepSeek · GLM…',
      'why.kicker': '背后的故事',
      ...
      'why.p2': '没有账号，没有云端，没有遥测。接入时，CCBuddy 替你写好 Claude Code 的配置；断开时，再原样还原。你的密钥、历史与用量从不离开本机。',
      'why.p3': '它开源，是因为一个夹在你请求中间的工具，理应能被你阅读、审计与信任。',
      'feat.kicker': '功能',
      'feat.title': '切换所需的一切 —— 不多不少',
      'feat.lede': '每一处设计都有理由。下面是它做什么，以及为什么这样做。',
      'f1.title': '一键接入',
      'f1.desc': '选一个服务商，点「接入」。CCBuddy 会把 Claude Code 指向本地网关；再点一次即可切回官方。无需终端，无需翻配置。',
      'f1.note': '<b>为何安全：</b>动手前我们会先为你的 Claude Code 配置做快照，断开时原样还原 —— 你永远不会被卡在「配置改了一半」的状态里。',
      'f2.title': '所有服务商，一处管理',
      'f2.desc': '把所有服务商放在一起，一点即换。可为每个服务商配置模型别名映射 —— Claude Code 依旧请求「opus」，CCBuddy 在背后悄悄路由到你选的模型。',
      ...
      'how.s2t': '点击接入', 'how.s2d': 'CCBuddy 写好 Claude Code 的配置，指向 localhost。就这样。',
      'how.s3t': '照常用 Claude Code', 'how.s3d': '一切都经由 CCBuddy —— 随时切换服务商，实时查看用量。',
      ...
      'faq.q1': '免费且开源吗？', 'faq.a1': '是的。CCBuddy 开源、免费使用 —— 你自带服务商密钥。',
      'faq.q2': '我的数据会被传走吗？', 'faq.a2': '不会。CCBuddy 以本地网关的形式运行在你机器上。密钥、对话与用量从不离开本机 —— 没有 CCBuddy 账号，也没有服务器。',
      'faq.q3': '支持哪些服务商？', 'faq.a3': '任意 Anthropic 兼容端点 —— Kimi、DeepSeek、GLM（智谱）、MiMo、Zenmux 等。填入 base URL 与密钥，或从预设开始。',
      'faq.q4': '会弄乱我的 Claude Code 配置吗？', 'faq.a4': '不会。接入前 CCBuddy 会为现有 Claude Code 配置做快照，断开时原样还原。',
    ...
    'zh-TW': {
      ...
      'flow.n1t': 'Claude Code', 'flow.n1s': '你的 CLI', 'flow.n2t': 'CCBuddy', 'flow.n2s': '本機閘道', 'flow.n3t': '任意服務商', 'flow.n3s': 'Kimi · DeepSeek · GLM…',
      'why.kicker': '背後的故事',
      ...
      'why.p2': '沒有帳號、沒有雲端、沒有遙測。接入時 CCBuddy 替你寫好 Claude Code 的設定，斷開時再原樣還原。你的金鑰、紀錄與用量從不離開本機。',
      'why.p3': '它開源，是因為一個夾在你請求中間的工具，理應能被你閱讀、稽核與信任。',
      'feat.kicker': '功能',
      'feat.title': '切換所需的一切 —— 不多不少',
      'feat.lede': '每一處設計都有理由。以下是它做什麼，以及為何這樣做。',
      'f1.title': '一鍵接入',
      'f1.desc': '選一個服務商，按「接入」。CCBuddy 會把 Claude Code 指向本機閘道；再按一次即可切回官方。不需終端機，不必翻設定。',
      'f1.note': '<b>為何安全：</b>動手前我們會先為你的 Claude Code 設定做快照，斷開時原樣還原 —— 你永遠不會卡在「設定改到一半」的狀態。',
      'f2.title': '所有服務商，一處管理',
      'f2.desc': '把所有服務商放在一起，一點即換。可為每個服務商設定模型別名對應 —— Claude Code 仍請求「opus」，CCBuddy 在背後悄悄路由到你選的模型。',
      ...
      'how.s2t': '點擊接入', 'how.s2d': 'CCBuddy 寫好 Claude Code 的設定，指向 localhost。就這樣。',
      'how.s3t': '照常用 Claude Code', 'how.s3d': '一切都經由 CCBuddy —— 隨時切換服務商，即時查看用量。',
      ...
      'faq.q1': '免費且開源嗎？', 'faq.a1': '是的。CCBuddy 開源、免費使用 —— 你自帶服務商金鑰。',
      'faq.q2': '我的資料會被傳走嗎？', 'faq.a2': '不會。CCBuddy 以本機閘道的形式執行在你機器上。金鑰、對話與用量從不離開本機 —— 沒有 CCBuddy 帳號，也沒有伺服器。',
      'faq.q3': '支援哪些服務商？', 'faq.a3': '任意 Anthropic 相容端點 —— Kimi、DeepSeek、GLM（智譜）、MiMo、Zenmux 等。填入 base URL 與金鑰，或從預設開始。',
      'faq.q4': '會弄亂我的 Claude Code 設定嗎？', 'faq.a4': '不會。接入前 CCBuddy 會為現有 Claude Code 設定做快照，斷開時原樣還原。',
    ...
    ja: {
      ...
      'flow.n1t': 'Claude Code', 'flow.n1s': 'あなたの CLI', 'flow.n2t': 'CCBuddy', 'flow.n2s': 'ローカルゲートウェイ', 'flow.n3t': '任意のプロバイダー', 'flow.n3s': 'Kimi · DeepSeek · GLM…',
      'why.kicker': '背景にある話',
      ...
      'why.p2': 'アカウントなし、クラウドなし、テレメトリなし。接続時に CCBuddy が Claude Code の設定を書き込み、切断時に元どおりに戻します。鍵・履歴・使用量が端末から出ることはありません。',
      ...
      'f1.title': 'ワンクリック接続',
      'f1.desc': 'プロバイダーを選んで「接続」を押すだけ。CCBuddy が Claude Code をローカルゲートウェイに向け、もう一度押せば公式に戻ります。ターミナルも設定の探検も不要。',
      'f1.note': '<b>安全な理由：</b>触れる前に Claude Code の設定をスナップショットし、切断時にその同じ状態へ正確に戻します。中途半端な設定で立ち往生することはありません。',
      'f2.title': 'すべてのプロバイダーを一枚の棚に',
      'f2.desc': 'すべてのプロバイダーを一か所にまとめ、クリックで切替。プロバイダーごとにモデルのエイリアスをマッピング —— Claude Code は「opus」を求め続け、CCBuddy が裏で選んだ先へ静かにルーティングします。',
      ...
      'how.s2t': '接続を押す', 'how.s2d': 'CCBuddy が Claude Code の設定を localhost に向けて書き込みます。それだけ。',
      'how.s3t': 'いつも通り Claude Code', 'how.s3d': 'すべてが CCBuddy を通ります —— いつでもプロバイダーを切替、使用量をリアルタイムで確認。',
      ...
      'faq.q1': '無料でオープンソースですか？', 'faq.a1': 'はい。CCBuddy はオープンソースで無料です —— プロバイダーの鍵はご自身で用意します。',
      'faq.q2': 'データはどこかへ送られますか？', 'faq.a2': 'いいえ。CCBuddy は端末上でローカルゲートウェイとして動作します。鍵・会話・使用量が外へ出ることはなく、CCBuddy のアカウントもサーバーもありません。',
    ...
    ko: {
      ...
      'flow.n1t': 'Claude Code', 'flow.n1s': '당신의 CLI', 'flow.n2t': 'CCBuddy', 'flow.n2s': '로컬 게이트웨이', 'flow.n3t': '임의의 프로바이더', 'flow.n3s': 'Kimi · DeepSeek · GLM…',
      'why.kicker': '뒷이야기',
      ...
      'why.p2': '계정 없음, 클라우드 없음, 텔레메트리 없음. 연결할 때 CCBuddy가 Claude Code 설정을 대신 써주고, 끊을 때 원래대로 정확히 되돌립니다. 키·기록·사용량은 기기를 벗어나지 않습니다.',
      ...
      'f1.title': '원클릭 연결',
      'f1.desc': '프로바이더를 고르고 “연결”을 누르세요. CCBuddy가 Claude Code를 로컬 게이트웨이로 향하게 하고, 다시 누르면 공식으로 돌아갑니다. 터미널도, 설정 탐험도 없습니다.',
      'f1.note': '<b>안전한 이유:</b> 손대기 전에 Claude Code 설정을 스냅샷하고, 끊을 때 그 스냅샷 그대로 복원합니다 —— 절반만 설정된 상태에 갇히는 일은 없습니다.',
      'f2.title': '모든 프로바이더를 한 선반에',
      'f2.desc': '모든 프로바이더를 한곳에 두고 클릭으로 전환. 프로바이더마다 모델 별칭을 매핑 —— Claude Code는 계속 “opus”를 요청하고, CCBuddy가 뒤에서 당신이 고른 곳으로 조용히 라우팅합니다.',
      ...
      'how.s2t': '연결 누르기', 'how.s2d': 'CCBuddy가 Claude Code 설정을 localhost로 향하게 씁니다. 그게 전부.',
      'how.s3t': '평소처럼 Claude Code', 'how.s3d': '모든 것이 CCBuddy를 거칩니다 —— 언제든 프로바이더 전환, 사용량 실시간 확인.',
      ...
      'faq.q1': '무료이고 오픈소스인가요?', 'faq.a1': '네. CCBuddy는 오픈소스이며 무료입니다 —— 프로바이더 키는 직접 준비합니다.',
      'faq.q2': '제 데이터가 어딘가로 가나요?', 'faq.a2': '아니요. CCBuddy는 기기에서 로컬 게이트웨이로 동작합니다. 키·대화·사용량은 절대 벗어나지 않으며, CCBuddy 계정도 서버도 없습니다.',
